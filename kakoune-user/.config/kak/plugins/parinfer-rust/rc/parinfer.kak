...
parinfer-enable-window -params ..1 %{
    ...
    printf "%s\n" "hook -group parinfer window NormalKey .* %{ parinfer-try-mode ${1:--smart} }
                   ...
                   set-option window parinfer_current_mode_modeline '${mode#-}'"
    }
}
...
parinfer-disable-window %{
    ...
    set-option window parinfer_current_mode_modeline ''
}
...
declare-option -docstring "Currently Parinfer active mode (value for modeline)" \
str parinfer_current_mode_modeline
